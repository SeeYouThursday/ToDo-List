...
import LoginFlow from '@/components/LoginFlow/Login';
...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Welcome Card set above bg Image Below */}
      <div
            ...
            {show ? null : (
              <CardBody className="flex flex-row justify-center items-start flex-wrap overflow-hidden">
                <p className="md:w-13 md:mx-7 text-9xl" id="hook">
                  Tired of being nagged or just not getting anything done? Sign
                  up today for a simple reminder to not be a coach potato so you
                  can just
                  <em> DO IT.</em>...or else
                </p>
              </CardBody>
